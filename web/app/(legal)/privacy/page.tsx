...
export const metadata: Metadata = {
  ...
  description:
    "How Veprio collects, uses, stores, and protects personal data across its WhatsApp automation platform.",
  alternates: {
    canonical: "/privacy",
  },
  openGraph: {
    title: "Privacy Policy — Veprio",
    description:
      "How Veprio collects, uses, stores, and protects personal data across its WhatsApp automation platform.",
    url: "/privacy",
      ...
      <div className={styles.container}>
        <header className={styles.docHead}>
          ...
          <p className={styles.docIntro}>
            This Privacy Policy explains how Veprio (&ldquo;Veprio&rdquo;,
      ...
      <div className={styles.container}>
        <div className={styles.docGrid}>
          ...
          <main className={styles.content}>
            ...
            <p>
              Veprio is a software platform that connects to a business&rsquo;s
            ...
            <p>
              ...
              and administer a Veprio account — we act as the data controller. We
            ...
            <p>
              ...
              on WhatsApp, the business is the data controller and Veprio acts as
              ...
              consents to communicate with its own customers and to use Veprio to
              do so.
            </p>
            ...
            <div className={styles.callout}>
              <p>
                ...
                through Veprio. If a business chooses to handle sensitive data (for
            ...
            <p>
              ...
              Veprio account and as needed to provide the service. When an account
            ...
            <p>
              ...
              by a business through Veprio, that business is the controller of your
            ...
            <p>
              Veprio is intended for use by businesses, not by children. Where a
