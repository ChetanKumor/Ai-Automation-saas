...
export const metadata: Metadata = {
  ...
  description:
    "The terms governing use of the Veprio WhatsApp automation platform.",
  alternates: {
    canonical: "/terms",
  },
  openGraph: {
    title: "Terms of Service — Veprio",
    description:
      "The terms governing use of the Veprio WhatsApp automation platform.",
    url: "/terms",
      ...
      <div className={styles.container}>
        <header className={styles.docHead}>
          ...
          <p className={styles.docIntro}>
            ...
            and use of the Veprio platform. By creating an account or using Veprio,
            you agree to these Terms. If you are using Veprio on behalf of a
        ...
        <div className={styles.docGrid}>
          ...
          <main className={styles.content}>
            ...
            <p>
              ...
              (&ldquo;Veprio&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;). They
            ...
            <p>
              Veprio provides a software platform that connects to your WhatsApp
            ...
            <p>
              ...
              under your account and for keeping your credentials secure. Veprio is
              intended for businesses, not for personal or consumer use.
            </p>

            <h2 id="responsibilities">4. Your responsibilities</h2>
            <p>
              You are responsible for how you use Veprio and the messages sent from
            ...
            <ul>
              ...
              <li>
                ...
                on WhatsApp and to process their data through Veprio.
              </li>
              <li>
              ...
              <li>
                You will not use Veprio to send spam or unsolicited messages, or
            ...
            <p>
              Veprio is charged as a one-time setup fee plus a recurring
            ...
            <p>
              Veprio depends on third-party services, including Meta&rsquo;s
            ...
            <p>
              We own all rights in the Veprio platform, software, and brand. We
            ...
            <p>
              Veprio uses AI to generate replies.{" "}
              <strong>
            ...
            <p>
              We work to keep Veprio available and reliable, but the service is
            ...
            <p>
              To the maximum extent permitted by law, Veprio will not be liable for
            ...
            <p>
              You agree to indemnify and hold Veprio harmless from claims, losses,
